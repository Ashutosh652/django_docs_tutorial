...
def create_question(question_text, days):
    #Create a question with the given 'question_text' and with publication date 'days' number of days offset to now
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_two_past_questions(self):
        #Testing if the index page displays multiple past questions
